...
export default function Items() {
  return (
    <>
      <div className="items-container w-full display-flex-column p-[1.5rem] gap-4 md:flex-row md:justify-center md:w-full md:flex-wrap">
        {selers.map((item, index) => (
          <div className="items display-flex-column md:w-[24%%] lg:w-[19%] xl:w-[15%]" key={index}>
